...
namespace HBergasa_ReservasHotel.vistas
{
    partial class ReservaSalones
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.comboCaterin = new System.Windows.Forms.ComboBox();
            ...
            this.campoPersonas = new System.Windows.Forms.TextBox();
            ...
            this.botonFactura.Location = new System.Drawing.Point(918, 797);
            ...
            this.calendario.Location = new System.Drawing.Point(225, 31);
            this.calendario.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.calendario.Name = "calendario";
            this.calendario.Size = new System.Drawing.Size(314, 26);
            this.calendario.TabIndex = 4;
            this.calendario.Tag = "FECHA";
            // 
            // comboCaterin
            // 
            this.comboCaterin.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.comboCaterin.Enabled = false;
            this.comboCaterin.FormattingEnabled = true;
            this.comboCaterin.Location = new System.Drawing.Point(225, 115);
            this.comboCaterin.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.comboCaterin.Name = "comboCaterin";
            this.comboCaterin.Size = new System.Drawing.Size(205, 28);
            this.comboCaterin.TabIndex = 3;
            this.comboCaterin.Tag = "CATERING";
            this.comboCaterin.SelectedIndexChanged += new System.EventHandler(this.comboCaterin_SelectedIndexChanged);
            // 
            // botonReserva
            // 
            ...
            this.botonReserva.Location = new System.Drawing.Point(250, 812);
            ...
            this.label11.Text = "Nº de Personas";
            // 
            // label10
            // 
            ...
            // panelReserva
            // 
            this.panelReserva.Controls.Add(this.campoPersonas);
            this.panelReserva.Controls.Add(this.calendario);
            this.panelReserva.Controls.Add(this.comboCaterin);
            ...
            this.panelReserva.Location = new System.Drawing.Point(20, 606);
            ...
            this.panelReserva.TabIndex = 9;
            this.panelReserva.TabStop = false;
            this.panelReserva.Text = "DATOS DE LA RESERVA";
            // 
            // campoPersonas
            // 
            this.campoPersonas.Enabled = false;
            this.campoPersonas.Location = new System.Drawing.Point(225, 72);
            this.campoPersonas.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.campoPersonas.Name = "campoPersonas";
            this.campoPersonas.Size = new System.Drawing.Size(205, 26);
            this.campoPersonas.TabIndex = 5;
            this.campoPersonas.Tag = "Nº DE PERSONAS";
            // 
            // botonComprobar
            // 
            ...
            this.botonComprobar.Location = new System.Drawing.Point(489, 29);
            this.botonComprobar.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.botonComprobar.Name = "botonComprobar";
            this.botonComprobar.Size = new System.Drawing.Size(144, 49);
            this.botonComprobar.TabIndex = 17;
            ...
            this.label13.Location = new System.Drawing.Point(766, 134);
            ...
            this.campoDni.Location = new System.Drawing.Point(226, 40);
            ...
            this.panelCliente.Location = new System.Drawing.Point(18, 134);
            ...
            this.areaTexto.Location = new System.Drawing.Point(771, 163);
            ...
            this.Text = "Reservas";
            this.Load += new System.EventHandler(this.ReservaSalones_Load);
        ...
        private System.Windows.Forms.ComboBox comboCaterin;
        ...
        private System.Windows.Forms.TextBox campoPersonas;
        ...
        public void Registro()
        {
            ...
            if (!campoDni.Text.Equals(campoDni.Text.ToUpper()))
            {
        ...
        private readonly double precioDesayuno = 60;
        private readonly double precioAlmuerzo = 75;
        private readonly double precioMerienda = 75;
        private readonly double precioComida = 90;
        private readonly double precioCena = 80;
        private readonly double precioFijo = 475;

        public double TotalPrecio()
        {
            int opcion = comboCaterin.SelectedIndex;
            double precio;

            switch (opcion)
            {
                case 0:
                    precio = (double.Parse(campoPersonas.Text) * precioCena + precioFijo);
                    break;
                case 1:
                    precio = precioFijo;
                    break;
                case 2:
                    precio = (double.Parse(campoPersonas.Text) * precioComida + precioFijo);
                    break;
                case 3:
                    precio = (double.Parse(campoPersonas.Text) * precioAlmuerzo + precioFijo);
                    break;
                case 4:
                    precio = (double.Parse(campoPersonas.Text) * precioMerienda + precioFijo);
                    break;
                case 5:
                    precio = (double.Parse(campoPersonas.Text) * precioDesayuno + precioFijo);
                    break;
                default:
        ...
        {
            factura = new FileInfo("FacturaDeHabitaciones.txt");

            if (!factura.Exists)
            {
                try
                {
                    factura.Create().Close();
                }
        ...
        public void ImprimeFactura()
        {
            try
            {
                using (StreamWriter pr = new StreamWriter(factura.FullName))
                {
                    pr.Write(areaTexto.Text);
                }
            }
            catch (IOException ex)
            {
        ...
        public void Reserva()
        {
            if (utilidades.Utilidades.CampoVacio(campoPersonas))
            {
                utilidades.Utilidades.LanzarAlertaVacio(campoPersonas);
                return;
            }

            if (utilidades.Utilidades.ComboVacio(comboCaterin))
            {
                utilidades.Utilidades.LanzarAlertaCombo(comboCaterin);
                return;
            }

            string dni = campoDni.Text;
            string dniResc = Login.dniRescatado;
            DateTime cal = calendario.Value;
            int per = int.Parse(campoPersonas.Text);
            string cat = comboCaterin.SelectedItem.ToString();
            double pre = TotalPrecio();

            modelo.Salones miSalon = new Salones(dni, dniResc, cal, per, cat, pre);

            if (bbdd.ConsultasSalones.reservarSalon(miSalon))
            {
                MessageBox.Show("Reserva Registrada Correctamente");
                botonFactura.Enabled = true;
                areaTexto.Text = miSalon.ToString();
                ImprimeFactura();
            }
            else
            {
